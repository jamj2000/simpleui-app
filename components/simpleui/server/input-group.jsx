...
const classGroup = "relative grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 p-5 pt-10 rounded-md shadow-sm text-xl w-full px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100"
