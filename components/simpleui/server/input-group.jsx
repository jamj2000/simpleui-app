...
const classGroup = "relative my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 p-5 pt-10 rounded-md shadow-sm text-xl w-full px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100"
