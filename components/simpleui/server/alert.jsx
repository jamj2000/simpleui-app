...
export const AlertInfo = ({ small = false, children }) => {
    return (
        <div className={`${styles.info} ${small ? "opacity-70 p-2 text-sm rounded-sm border border-red-100" : "p-4 rounded-xl border-l-4"}`}>
            {children}
        </div>
    )
}
...
export const AlertSuccess = ({ small = false, children }) => {
    return (
        <div className={`${styles.success} ${small ? "opacity-70 p-2 text-sm rounded-sm border border-red-100" : "p-4 rounded-xl border-l-4"}`}>
            {children}
        </div>
    )
}
...
export const AlertWarning = ({ small = false, children }) => {
    return (
        <div className={`${styles.warning} ${small ? "opacity-70 p-2 text-sm rounded-sm border border-red-100" : "p-4 rounded-xl border-l-4"}`}>
            {children}
        </div>
    )
}
...
export const AlertError = ({ small = false, children }) => {
    return (
        <div className={`${styles.error} ${small ? "opacity-70 p-2 text-sm rounded-sm border border-red-100" : "p-4 rounded-xl border-l-4"}`}>
            {children}
        </div>
    )
}
