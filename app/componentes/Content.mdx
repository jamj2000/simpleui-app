import { Drawer, Submit, Alert, Badge, Dropdown, Dropdown2, MainMenu, HomeIcon, MenuLink, Modal, Tooltip, Popover, Separator, Skeleton, Space, Spinner, Switch, InputText,  InputNumber, InputRange, InputDate, InputImage, InputCheck, InputGroup, InputSelect, DragAndDrop, Button, InputArea, Form, Table, List, Card, List2, Card2, CircleIcon, SquareIcon, HeartIcon, StarIcon, HexagonIcon, CrossIcon } from "@/components/simpleui";

import { CardEmpleado } from '@/components/CardEmpleado'
import { CardEmpleado2 } from '@/components/CardEmpleado2'
import { CreateEmpleado, DeleteEmpleado, UpdateEmpleado, ViewEmpleado } from "@/components/Actions";
...
<Prop name="width" value="w-20 md:w-80" values={["clases tailwindcss para móvil y desktop (md)"]} />
<Prop name="duration" value="300" values={["tiempo en milisegundos que tarda en abrirse y cerrarse la barra lateral"]} />
<Prop name="permanent" value="false" values={["poner a true si deseas que la barra lateral sea permanente"]} />
...
<Prop name="header" values={["componente que se muestra en la cabecera"]} />
<Prop name="leftsidebar" values={["componente que se muestra en la barra lateral izquierda"]} />
<Prop name="rightsidebar" values={["componente que se muestra en la barra lateral derecha"]} />
<Prop name="footer" values={["componente que se muestra en el pie de página"]} />
<Prop name="children" values={["contenido de la página"]} />
...
<Prop name="value" value="false" values={["true", "false"]}/>
<Prop name="onChange" values={["función a ejectar en el servidor"]}/>
<Prop name="labelOn" values={["mensaje cuando valor es true"]} />
<Prop name="labelOff" values={["mensaje cuando valor es false"]} />
...
<Prop name="label" values={["cualquier texto a mostrar"]} />
<Prop name="name" values={["nombre del input"]} />
<Prop name="options" values={["formato que se muestra en el código de ejemplo"]} />
<Prop name="icon" value={"check circular"} values={["consultar Icons"]} />
...
<Prop name="label" values={["cualquier texto a mostrar"]} />
<Prop name="name" values={["nombre del input"]} />
<Prop name="options" values={["formato que se muestra en el código de ejemplo de ene"]} />
<Prop name="icon" value={"check cuadrado"} values={["consultar Icons"]} />
<Prop name="multiple" />
