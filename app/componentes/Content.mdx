import { Drawer, Submit, Alert, Badge, Dropdown, Dropdown2, MainMenu, HomeIcon, MenuLink, Modal, Tooltip, Popover, Separator, Skeleton, Space, Spinner, Switch, InputText,  InputNumber, InputRange, InputDate, InputImage, InputCheck, InputGroup, InputSelect, DragAndDrop, Button, Form, Table, List, Card, List2, Card2, CircleIcon, SquareIcon, HeartIcon, StarIcon, HexagonIcon, CrossIcon } from "@/components/simpleui";

import { CardEmpleado } from '../test/CardEmpleado'
import { CardEmpleado2 } from '../test/CardEmpleado2'
...
>
  ...
  <div className="flex flex-col text-sm md:text-base">
    ...
    <Link href="/componentes#switch">Switch</Link>  
    ...
    <Link href="/componentes#list2">List2</Link>  
    <Link href="/componentes#card2">Card2</Link>  
...
<Prop name="className" value="px-4 py-2 rounded-md dark:text-white" values={["clases tailwindcss deseadas"]} /> 
<Prop name="classCheck" value="bg-slate-700 text-white" values={["clases tailwindcss deseadas enlace marcado"]} />
<Prop name="classHover" value="hover:underline hover:underline-offset-8" values={["clases tailwindcss deseadas para hover"]} />
<Prop name="classActive" value="active:decoration-2 active:decoration-blue-400" values={["clases tailwindcss deseadas para active"]} />
...
<Switch
    ...
    onChange={(value) => toggleEmpleadoActivo(proveedor.id, value)}
/>
```
