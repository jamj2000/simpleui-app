import { ClientZone, Drawer, Submit, Alert, Badge, Dropdown, Dropdown2, Modal, Popover, Separator, Skeleton, Space, Spinner, Tooltip, InputText,  InputNumber, InputRange, InputDate,   InputGroup, InputSelect, DragAndDrop, Button, Form, CircleIcon, SquareIcon, HeartIcon, StarIcon, HexagonIcon, CrossIcon, } from "@/components/simpleui";
...
>
  ...
  <div className="flex flex-col">
    ...
    <Link href="/componentes#inputgroupmultiple">Inputgroupmultiple</Link>  
    <Link href="/componentes#inputselect">Inputselect</Link>  
    <Link href="/componentes#inputselectmultiple">Inputselectmultiple</Link>  
